...
| 3 | Temp/humidity sensor (outdoor) | SHT30 IOT-TH02 | 1 | 2.15–5.5V | I2C address 0x44, loose color-coded wires | Amazon | ✅ In hand |
| 4 | Temp/humidity sensor (indoor) | SHT30 IOT-TH02 | 1 | 2.15–5.5V | I2C address 0x44, loose color-coded wires | Amazon | ✅ In hand |
| 5 | Soil moisture sensor | M5Stack Earth Sensor | 2 | 3.3–5V | Analog + digital output, Grove HY2.0 | M5Stack | ✅ In hand |
| 6 | Relay module | M5Stack Mini 3A Relay | 2 | 5V control | 3A/30VDC, Grove HY2.0, NO/NC/COM | M5Stack | ✅ In hand |
| 7 | Peristaltic pump | DC 12–24V pump | 2 | 12V | ~100 ml/min, 80mA, reversible, tubing included | Amazon | ✅ In hand |
| 8 | Water level sensor | XKC-Y25-V + DFRobot driver | 1 | 5–24V | Non-contact capacitive, digital output, 4 sensitivity levels | Amazon | ✅ In hand |
| 9 | Indoor unit (all-in-one) | ESP32-2432S028 CYD | 2 | 5V USB | ESP32 dual-core + 2.8" TFT 240x320 color + resistive touch. One per room (master + kids). I2C SHT30 on CN1 (GPIO21/22) | Amazon | ✅ In hand |
| 10 | Grove↔Dupont cable | HY2.0-4P to 2.54mm female 20cm | 2 | — | Connects SHT30 to Station-485 Grove ports. WatangTech on Amazon | Amazon | ✅ In hand |
| 11 | Timelapse camera | M5Stack ESP32 PSRAM Timer Camera X (OV3660) | 1 | 5V USB | 3MP 2048x1536, FOV 66.5°, WiFi, RTC BM8563, battery 140mAh, sleep 2µA. One unit covers both planters. 48x24x15mm | M5Stack | ✅ In hand |
...
|---|---|---|---|---|---|---|
| 13 | DC power adapter | 12V 2A, 5.5x2.1mm barrel jack | 1 | Powers Station-485 + both pumps from single source | Amazon | ✅ In hand |
| 16 | DC-DC buck converter | LM2596 adjustable, 4–40V in, 1.25–37V out, 2A | 2 | Set to 5V output (built-in voltmeter display). Powers TimerCam X from 12V rail. 1 unit + 1 spare | Amazon | ✅ In hand |
| 17 | Power distribution connectors | Wago 221-415 lever nuts (5-port) | 2 | One for +12V rail, one for GND rail. No soldering required. 1 input → 4 outputs each | Amazon | ✅ In hand |
| 14 | Outdoor weatherproof enclosure | IP65 min, 150x120x80mm min, ventilation slots or fan mount | 1 | Must handle Orlando summer heat — shade installation mandatory | Amazon | ✅ In hand |
| 15 | Indoor unit enclosure x2 | Custom 3D printed | 2 | Contains CYD ESP32-2432S028 + SHT30 (wall frame). Same design printed twice | 3D Print Service | ✅ In hand |
