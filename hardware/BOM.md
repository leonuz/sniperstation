...
|---|---|---|---|---|---|---|
| 13 | DC power adapter | 12V 2A, 5.5x2.1mm barrel jack | 1 | Powers Station-485 + both pumps from single source | Amazon | 🚚 Ordered |
...
| 14 | Outdoor weatherproof enclosure | IP65 min, 150x120x80mm min, ventilation slots or fan mount | 1 | Must handle Orlando summer heat — shade installation mandatory | Amazon | ⏳ Pending |
| 15 | Indoor unit enclosure x2 | Custom 3D printed | 2 | Contains CYD ESP32-2432S028 + SHT30 (wall frame). Same design printed twice | 3D Print Service | ⏳ Pending |
